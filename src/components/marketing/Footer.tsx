...
const cols = {
  ...
  Claude: [
    { label: "Agence Claude", href: "/agence-claude" },
    { label: "Formation Claude", href: "/formation-claude" },
    { label: "Deployer Claude en entreprise", href: "/deployer-claude-entreprise" },
    { label: "Claude pour le business B2B", href: "/claude-business" },
    { label: "Guide Claude & Marketing", href: "/guide-claude-marketing" },
  ],
  Expertise: [
  ...
  Ressources: [
    { label: "Notre methode (4 phases)", href: "/methode" },
    { label: "Framework SCORE", href: "/framework-score-revops" },
    { label: "Blog", href: "/blog" },
    { label: "Guides (8 gratuits)", href: "/guides" },
    { label: "Guide MCP pour le RevOps", href: "/guide-mcp-revops" },
    { label: "Guide RevOps Ultime", href: "/guide-revops-ultime" },
    { label: "Cas clients", href: "/cas-clients" },
    { label: "Glossaire RevOps (78 termes)", href: "/glossaire" },
    { label: "Outils B2B (173+)", href: "/outils" },
    { label: "Calculateur CAC Payback", href: "/outils/calculateur-cac-payback" },
    { label: "Calculateur LTV/CAC", href: "/outils/calculateur-ltv-cac" },
    { label: "Calculateur Pipeline Coverage", href: "/outils/calculateur-pipeline-coverage" },
  ],
  Metiers: [
    { label: "Sales Ops Manager", href: "/metier/sales-ops-manager" },
    { label: "CRM Manager", href: "/metier/crm-manager" },
    { label: "RevOps Director", href: "/metier/revops-director" },
    { label: "CRO (Chief Revenue Officer)", href: "/metier/cro-chief-revenue-officer" },
    { label: "RevOps Manager", href: "/blog/revops-manager-fiche-poste-salaire-competences" },
    { label: "Marketing Ops", href: "/blog/marketing-ops-definition" },
    { label: "Comment choisir agence RevOps", href: "/comment-choisir-agence-revops" },
    { label: "Comment choisir consultant RevOps", href: "/comment-choisir-consultant-revops" },
  ],
  Comparatifs: [
    { label: "HubSpot vs Salesforce", href: "/hubspot-vs-salesforce" },
    { label: "HubSpot vs Attio", href: "/hubspot-vs-attio" },
    { label: "HubSpot vs Pipedrive", href: "/hubspot-vs-pipedrive" },
    { label: "HubSpot vs Folk", href: "/hubspot-vs-folk" },
    { label: "HubSpot vs Monday CRM", href: "/hubspot-vs-monday-crm" },
    { label: "HubSpot vs Notion CRM", href: "/hubspot-vs-notion-crm" },
    { label: "Attio vs Pipedrive", href: "/attio-vs-pipedrive" },
    { label: "Salesforce vs Attio", href: "/salesforce-vs-attio" },
    { label: "Salesforce vs Pipedrive", href: "/salesforce-vs-pipedrive" },
    { label: "Claude vs ChatGPT vs Gemini", href: "/claude-vs-chatgpt-vs-gemini-b2b" },
  ],
  Solutions: [
