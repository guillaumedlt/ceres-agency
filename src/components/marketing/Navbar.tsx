...
const resources = [
  { label: "Notre methode", href: "/methode", desc: "RevOps en 4 phases + framework SCORE", color: "#FF7A59",
    icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" /></svg> },
  ...
  { label: "Outils & calculateurs", href: "/outils", desc: "173+ outils B2B + 3 calculateurs SaaS", color: "#D4A27F",
  ...
  { label: "Fiches metier RevOps", href: "/metier", desc: "Sales Ops, CRM Manager, RevOps Director, CRO", color: "#6D00CC",
