...
const services = [
  ...
  { label: "Fondation Data", href: "/fondation-data", desc: "CRM propre, KPIs alignes", color: "#22C55E",
  ...
  { label: "Automatisation", href: "/agents-ia", desc: "Workflows, scoring, reporting", color: "#6D00CC",
  ...
  { label: "Accompagnement", href: "/revops-part-time", desc: "Expert RevOps dedie chaque mois", color: "#4B5EFC",
...
const resources = [
  { label: "Notre methode", href: "/methode", desc: "4 phases RevOps : Audit, Design, Build, Run", color: "#FF7A59",
    icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" /></svg> },
  { label: "Framework SCORE", href: "/framework-score-revops", desc: "Auto-evaluer votre revenue engine en 5 piliers", color: "#22C55E",
    icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> },
  { label: "Guides", href: "/guides", desc: "8 playbooks gratuits dont le Guide MCP", color: "#6C5CE7",
  ...
  { label: "Calculateurs", href: "/outils/calculateur-cac-payback", desc: "CAC Payback, LTV/CAC, Pipeline Coverage", color: "#D4A27F",
    icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path strokeLinecap="round" strokeLinejoin="round" d="M9 5.25H7.5A2.25 2.25 0 005.25 7.5v9a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25H15M9 12l2 2 4-4m1.5-7.5H9.75A2.25 2.25 0 007.5 4.75v.5h9v-.5A2.25 2.25 0 0014.25 2.5h-1.5z" /></svg> },
  { label: "Outils B2B", href: "/outils", desc: "173+ outils RevOps tries par categorie", color: "#FF7A59",
  ...
  { label: "Glossaire RevOps", href: "/glossaire", desc: "78 termes RevOps, CRM, Marketing, Data, IA", color: "#4B5EFC",
    icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" /></svg> },
  { label: "Fiches metier RevOps", href: "/metier/sales-ops-manager", desc: "Sales Ops, CRM Manager, RevOps Director, CRO", color: "#6D00CC",
    icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" /></svg> },
  { label: "Blog", href: "/blog", desc: "100+ articles RevOps & IA", color: "#22C55E",
