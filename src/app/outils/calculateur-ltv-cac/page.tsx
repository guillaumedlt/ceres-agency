...
export default function CalculateurLTVCACPage() {
  ...
  return (
    <div className="relative pt-[80px] md:pt-[100px] pb-16 overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-6">
        ...
        <section className="mb-8">
          <div className="rounded-2xl p-8 text-center" style={{ background: "linear-gradient(135deg, #FF7A59, #E8533F)" }}>
            ...
            <p className="text-[14px] text-white/70 mb-5 max-w-[460px] mx-auto">30 minutes avec Guillaume Delachet (co-fondateur) pour identifier les leviers concrets : pricing, retention, expansion, acquisition. Sans engagement.</p>
      ...
      <StickyBottomCTA
        message="Discuter de votre ratio LTV/CAC avec Guillaume Delachet"
        ctaLabel="Reserver"
