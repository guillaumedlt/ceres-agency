...
export const metadata: Metadata = {
  title: "Agence HubSpot Nantes — Setup, Migration & Optimisation CRM | Ceres",
  description:
...
const whyNantes = [
  { title: "Capitale du Grand Ouest", desc: "Nantes est le poumon economique du Grand Ouest francais. On connait le tissu d'entreprises local, de l'industrie maritime au SaaS en passant par l'economie sociale et solidaire.", color: "#FF7A59" },
  { title: "French Tech capitale", desc: "Nantes est labellisee French Tech capitale. La Cantine, Trempolino, l'ile de Nantes : l'ecosysteme d'innovation nantais est l'un des plus dynamiques de France. On accompagne ses acteurs.", color: "#4B5EFC" },
  { title: "2h15 de Paris en TGV", desc: "La ligne TGV relie Nantes a Paris en 2h15. On se deplace pour les ateliers de cadrage, formations et go-live dans vos locaux a l'ile de Nantes, Euronantes ou centre-ville.", color: "#6D00CC" },
  ...
  { title: "Rayonnement Grand Ouest", desc: "Depuis Nantes, on accompagne aussi vos equipes a Rennes, Angers, Saint-Nazaire et La Roche-sur-Yon. Un seul partenaire HubSpot pour tout le Grand Ouest.", color: "#6C5CE7" },
...
const services = [
  { title: "Setup HubSpot complet", desc: "Configuration de votre instance HubSpot de zero. Pipelines, proprietes custom, vues par equipe, workflows d'automatisation, integrations stack et formation de vos utilisateurs. On configure HubSpot selon vos process, pas l'inverse.", items: ["Cadrage process avec vos equipes", "Config pipelines, proprietes, vues", "Workflows & automatisations", "Integrations stack (Slack, Pennylane, etc.)", "Formation utilisateurs sur site a Nantes"], color: "#FF7A59", duration: "3-4 sem", link: "/agence-hubspot" },
  ...
  { title: "Formation HubSpot", desc: "Formation sur site dans vos locaux nantais ou en remote. Adaptee a vos process, pas un tuto generique. Par equipe : Sales, Marketing, CS, Ops, Direction.", items: ["Formation sur site a Nantes", "Sessions par equipe", "Exercices sur vos donnees", "Support post-formation", "Documentation personnalisee"], color: "#22C55E", duration: "1-2 jours", link: "/agence-hubspot" },
...
const clientResults = [
  { client: "SaaS B2B ile de Nantes", result: "Setup HubSpot complet en 3 semaines. Integration outils metier et formation de 12 utilisateurs sur site.", metric: "3 semaines" },
  { client: "Industrie maritime Saint-Nazaire", result: "Migration Dynamics vers HubSpot. Pipeline adapte aux cycles de vente longs du secteur naval. Adoption a 90%.", metric: "90% adoption" },
  { client: "ESS Nantes Euronantes", result: "Optimisation HubSpot : nettoyage donnees, refonte workflows, mise en place reporting impact social.", metric: "30+ workflows" },
];
...
const faqItems = [
  { q: "Combien coute une agence HubSpot a Nantes ?", a: "Le cout depend du perimetre : un audit demarre a 2 500\u00a0\u20ac, un setup complet entre 5 000 et 15 000\u00a0\u20ac, une migration entre 8 000 et 25 000\u00a0\u20ac. L'appel de cadrage est gratuit et sans engagement." },
  { q: "Pourquoi choisir une agence HubSpot pour Nantes ?", a: "Proximite pour les ateliers sur site, connaissance de l'ecosysteme Grand Ouest (maritime, industrie, SaaS, ESS) et reactivite garantie dans le meme fuseau horaire." },
  ...
  { q: "Proposez-vous des formations HubSpot sur site a Nantes ?", a: "Oui, nous nous deplacons dans vos locaux nantais pour des formations adaptees a vos process. Formations par equipe (Sales, Marketing, CS) avec exercices sur vos propres donnees." },
  { q: "Accompagnez-vous les entreprises de l'industrie maritime ?", a: "Oui. Nous avons l'experience des cycles de vente longs et complexes propres au secteur naval et maritime. HubSpot s'adapte parfaitement a ces problematiques avec des pipelines multi-etapes et du reporting avance." },
  { q: "Intervenez-vous aussi a Rennes et Angers ?", a: "Oui. Depuis Nantes, nous intervenons sur tout le Grand Ouest : Rennes, Angers, Saint-Nazaire, La Roche-sur-Yon. Ateliers sur site et support remote." },
];

const temoignages = [
  { citation: "Ceres a deploye notre HubSpot en 3 semaines. L'equipe s'est deplacee a l'ile de Nantes pour la formation, tout le monde etait operationnel des le premier jour.", auteur: "Directeur Commercial", entreprise: "SaaS B2B, ile de Nantes" },
  { citation: "La migration depuis Dynamics s'est faite sans aucune interruption. Notre pipeline naval complexe a ete parfaitement reconstruit dans HubSpot.", auteur: "Responsable CRM", entreprise: "Industrie maritime, Saint-Nazaire" },
  { citation: "L'optimisation de notre HubSpot a transforme notre suivi d'impact. On a enfin des dashboards qui parlent a nos financeurs et partenaires.", auteur: "Directrice Operations", entreprise: "ESS, Nantes" },
];
...
const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      name: "Ceres - Agence HubSpot Nantes",
      description: "Agence HubSpot a Nantes. Setup, migration, optimisation et formation HubSpot pour entreprises du Grand Ouest. Partenaire certifie, 250+ clients.",
      address: {
        "@type": "PostalAddress",
    ...
    {
      "@type": "Service",
      name: "Agence HubSpot Nantes",
      provider: { "@type": "Organization", name: "Ceres" },
      description: "Agence HubSpot a Nantes specialisee RevOps & IA. Configuration, migration Salesforce, optimisation, formation sur site.",
...
export default function AgenceHubSpotNantesPage() {
  return (
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-6">
        ...
        <nav aria-label="Breadcrumb" className="mb-8">
          <ol className="flex items-center gap-1.5 text-[12px] text-[#999]">
            ...
            <li>/</li>
            <li className="text-[#111] font-medium">Nantes</li>
          </ol>
        </nav>

        {/* ── 1. Hero ──────────────────────────────────────────────────────────── */}
        <section className="text-center mb-20">
          <div className="mb-4"><Badge>Agence HubSpot Nantes</Badge></div>
          <h1 className="text-[36px] sm:text-[48px] font-semibold text-[#111] leading-[1.1] tracking-[-0.03em] mb-5">
            Agence HubSpot a Nantes : votre partenaire certifie
          </h1>
          <p className="text-[17px] text-[#666] max-w-[580px] mx-auto leading-[1.7] mb-6">
            Setup, migration, optimisation et formation HubSpot. Nous accompagnons les entreprises du Grand Ouest dans le deploiement et l&apos;exploitation de HubSpot depuis 9 ans.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-6 mb-8">
            ...
            <div className="w-px h-8 bg-[#E8E8E8] hidden sm:block" />
            <div className="text-center">
              <p className="text-[28px] font-bold text-[#111]">2h15 TGV</p>
              <p className="text-[12px] text-[#999]">Paris-Nantes</p>
            </div>
          </div>
          <Link
            href="/contact"
        ...
        {/* ── 2. Pourquoi choisir une agence HubSpot a Nantes ────────────────── */}
        <section>
          <div className="text-center mb-10">
            ...
            <h2 className="text-[24px] sm:text-[30px] font-semibold text-[#111] tracking-[-0.02em] mb-2">
              Pourquoi choisir une agence HubSpot a Nantes
            </h2>
            <p className="text-[13px] text-[#999] max-w-[520px] mx-auto">
              Travailler avec une agence HubSpot proche de Nantes, c&apos;est gagner en reactivite, en comprehension de votre ecosysteme regional et en efficacite sur le terrain.
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-[#111] p-6 md:p-10">
            <div className="mb-8">
              ...
              <h2 className="text-[24px] sm:text-[30px] font-semibold text-white tracking-[-0.02em] mb-2">
                Partenaire HubSpot certifie a Nantes
              </h2>
            ...
            <div className="mt-8 pt-6 border-t border-white/10">
              <h3 className="text-[14px] font-semibold text-white mb-3">Zones d&apos;intervention depuis Nantes</h3>
              <ul className="space-y-2">
                {[
                  "Nantes et agglom\u00e9ration (\u00eele de Nantes, Euronantes, centre-ville)",
        ...
        <section>
          <div className="text-center mb-10">
            ...
            <h2 className="text-[24px] sm:text-[30px] font-semibold text-[#111] tracking-[-0.02em] mb-2">
              Migration vers HubSpot depuis Nantes
            </h2>
            <p className="text-[13px] text-[#999] max-w-[520px] mx-auto">
              Vous utilisez Salesforce, Dynamics 365 ou Pipedrive et vous envisagez HubSpot. Notre agence gere la migration de A a Z pour les entreprises nantaises.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-[#E8E8E8] bg-white p-6 md:p-10 shadow-[0_4px_20px_-8px_rgba(0,0,0,0.06)]">
            <div className="mb-8">
              ...
              <h2 className="text-[20px] sm:text-[24px] font-semibold text-[#111] tracking-[-0.02em]">
                Questions frequentes sur notre agence HubSpot a Nantes
              </h2>
            </div>
        ...
        <section>
          <div className="text-center mb-10">
            ...
            <h2 className="text-[24px] sm:text-[30px] font-semibold text-[#111] tracking-[-0.02em]">
              Ce que disent nos clients nantais
            </h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {temoignages.map((t, i) => (
        ...
        <section>
          <div className="rounded-2xl border border-[#E8E8E8] bg-[#FAFAFA] p-8 md:p-12 text-center">
            <h2 className="text-[24px] sm:text-[30px] font-semibold text-[#111] tracking-[-0.02em] mb-3">
              Un projet HubSpot a Nantes ?
            </h2>
            <p className="text-[14px] text-[#999] mb-3 max-w-[480px] mx-auto">
              Setup, migration, optimisation, formation ou administration recurrente. Notre agence HubSpot vous accompagne de A a Z sur tout le Grand Ouest. L&apos;appel de cadrage est gratuit et sans engagement.
            </p>
            <p className="text-[12px] text-[#999] mb-6">Nantes -- 2h15 de Paris en TGV</p>
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-5 py-2 rounded-md bg-[#111] text-white text-[13px] font-medium hover:bg-[#222] transition-colors"
            >
