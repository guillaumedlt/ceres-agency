        ...
        <section id="contact">
          <div className="rounded-2xl border border-[#E8E8E8] bg-[#FAFAFA] p-8 md:p-12 text-center">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <a href="mailto:hello@ceres.agency" className="inline-flex items-center px-5 py-2 rounded-md text-[13px] text-[#666] hover:text-[#111] hover:bg-[#F0F0F0] transition-colors">
                Nous écrire
              </a>
            </div>
          </div>
