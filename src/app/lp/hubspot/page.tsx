...
export default function LPHubSpot() {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
            ...
            <div className="flex-1 pt-4 lg:pt-8">
              ...
              <h1 className="text-[30px] sm:text-[40px] lg:text-[46px] font-semibold text-[#111] leading-[1.1] tracking-[-0.03em] mb-5">
                Votre HubSpot ne<br />donne pas de<br />resultats ?
              </h1>
              <p className="text-[16px] text-[#666] leading-[1.7] mb-6 max-w-[440px]">
                On configure, migre et optimise votre HubSpot. Setup en 4 semaines, migration sans perte de donnees. Partenaire certifie.
              </p>
              ...
              <div className="flex flex-wrap gap-4 mb-6">
                {[
                  ...
                  { value: "Partenaire", label: "HubSpot" },
                  { value: "4 sem", label: "setup" },
                ].map((s) => (
            ...
            <div className="w-full lg:w-[400px] shrink-0">
              <div className="rounded-2xl border border-[#E8E8E8] bg-white p-6 shadow-[0_8px_30px_-10px_rgba(0,0,0,0.1)]">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[13px] font-semibold text-[#111]">Demander votre devis gratuit</span>
                </div>
      ...
      <section className="bg-[#111] py-5">
        <div className="max-w-[1000px] mx-auto px-6">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              { value: "45K+", label: "Contacts migres", color: "#22C55E" },
              { value: "0", label: "Perte de donnees", color: "#FF7A59" },
              { value: "-45%", label: "Cout CRM", color: "#4B5EFC" },
              { value: "90%+", label: "Adoption equipe", color: "#6C5CE7" },
            ].map((s) => (
      ...
      <section className="py-14">
        <div className="max-w-[900px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-14">
            {[
              { problem: "HubSpot est mal configure", desc: "Les proprietes sont en vrac, les pipelines ne correspondent pas a votre cycle de vente, les deals stagnent." },
              { problem: "Pas de reporting fiable", desc: "Impossible de savoir ce qui fonctionne. Les dashboards sont vides ou faux. Personne ne les regarde." },
              { problem: "Les workflows n\u2019existent pas", desc: "Tout est manuel : relances, assignation des leads, nurturing. Vos commerciaux perdent des heures." },
              { problem: "L\u2019equipe n\u2019utilise pas le CRM", desc: "Les commerciaux remplissent HubSpot a contrecoeur. Les donnees sont incompletes, le management navigue a vue." },
            ].map((p) => (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              { step: "01", title: "Audit", desc: "On analyse votre portail HubSpot, vos processus et vos integrations. Rapport detaille en 48h.", time: "48h", color: "#FF7A59" },
              { step: "02", title: "Configuration", desc: "Pipeline, proprietes, workflows, dashboards, integrations. Tout est deploye, teste et documente.", time: "4 sem", color: "#4B5EFC" },
              { step: "03", title: "Formation", desc: "On forme vos equipes pour garantir l\u2019adoption. Support inclus pendant 3 mois apres le deploiement.", time: "Incluse", color: "#22C55E" },
            ].map((s) => (
      ...
      <section className="py-10 bg-[#FAFAFA]">
        <div className="max-w-[900px] mx-auto px-6">
          <h2 className="text-[20px] font-semibold text-[#111] text-center tracking-[-0.02em] mb-8">Nos services HubSpot</h2>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              { title: "Setup HubSpot", color: "#FF7A59" },
              { title: "Migration CRM", color: "#4B5EFC" },
              { title: "Optimisation", color: "#22C55E" },
              { title: "Formation", color: "#6C5CE7" },
            ].map((s) => (
        ...
        <div className="max-w-[900px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              { quote: "En 4 semaines, notre HubSpot est passe d\u2019un outil subi a un vrai levier de croissance. L\u2019equipe l\u2019a adopte du jour au lendemain.", author: "Equipe", role: "Direction", company: "Elax Energie" },
            ].map((t) => (
      ...
      <section className="py-14 bg-[#111]">
        <div className="max-w-[600px] mx-auto px-6 text-center">
          <h2 className="text-[24px] sm:text-[32px] font-semibold text-white tracking-[-0.02em] mb-3">Pret a tirer le meilleur de HubSpot ?</h2>
          <p className="text-[14px] text-white/50 mb-6 leading-[1.7]">Demandez votre devis gratuit. On vous repond sous 24h.</p>
