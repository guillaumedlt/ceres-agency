...
const guides: Guide[] = [
  ...
  {
    slug: "guide-outbound-b2b",
    title: "Guide Outbound B2B",
    subtitle: "Cold email, LinkedIn et IA en 2026",
    description: "Le guide outbound le plus complet en francais. Cold email, LinkedIn, Clay, Lemlist AI enrichment, signaux d\u2019achat, Claude Code, warm-up et sequences multicanal. Base sur +50 campagnes gerees chez Ceres.",
    category: "outbound",
    pages: 55,
    format: "PDF + Templates + Prompts",
    color: "#6C5CE7",
    icon: "O",
    landingUrl: "/guide-outbound-b2b",
    featured: true,
    chapters: [
      "L\u2019outbound B2B en 2026 : les nouvelles regles",
      "Construire votre ICP outbound",
      "Sourcing : LinkedIn, Lemlist, Clay, Apollo",
      "Enrichissement IA : Lemlist AI + Clay + Claude",
      "Warm-up et delivrabilite",
      "Rediger des cold emails qui convertissent",
      "Sequences multicanal : email + LinkedIn",
      "Lemlist : configuration complete",
      "IA et automatisation avancee (Claude Code)",
      "Mesurer, iterer et scaler",
    ],
    includes: [
      "55 pages de methode + exemples reels",
      "12 templates d\u2019emails prouves (8-15% reponse)",
      "5 sequences multicanal completes",
      "15 prompts Claude pour l\u2019enrichissement",
      "Workflow Make pret a importer",
      "Calculateur de volume d\u2019envoi (Sheets)",
      "Checklist warm-up complete",
    ],
    forWho: [
      "SDR et BDR qui veulent ameliorer leurs resultats",
      "Founders qui prospectent eux-memes",
      "Equipes sales qui lancent leur premier canal outbound",
      "Agences qui gerent la prospection de leurs clients",
    ],
  },
  {
    slug: "guide-migration-crm",
    title: "Guide Migration CRM",
    subtitle: "Changer de CRM sans tout casser",
    description: "Le guide migration CRM le plus complet en francais. Comparatif 7 CRM 2026 (HubSpot, Salesforce, Attio, Folk, Pipedrive, Odoo, Notion), methodologie, checklists et cas clients TotalEnergies, Dougs, HiPay.",
    category: "crm",
    pages: 50,
    format: "PDF + Sheets + Checklists",
    color: "#4B5EFC",
    icon: "M",
    landingUrl: "/guide-migration-crm",
    featured: true,
    chapters: [
      "Quand faut-il changer de CRM",
      "Comparatif CRM 2026 : 7 CRM compares",
    ...
    includes: [
      "50 pages de methode + cas concrets",
      "Comparatif detaille de 7 CRM (16 criteres)",
      "Template mapping des champs (Sheets)",
      "Checklists pre/post migration",
      "Plan de formation par role",
      "Timeline de migration (Gantt)",
      "Guide Salesforce vers HubSpot",
    ],
    forWho: [
      "Equipes qui changent de CRM",
      "Admins CRM en charge de la migration",
      "Directeurs commerciaux evaluant un nouveau CRM",
      "Consultants et agences CRM",
    ],
  },
  {
    slug: "guide-data-quality-crm",
    title: "Guide Data Quality CRM",
    subtitle: "Audit, nettoyage et enrichissement IA",
    description: "Le guide data quality le plus complet en francais. Audit 5 dimensions, deduplication, enrichissement Clay + Lemlist AI + Claude Code, maintenance automatisee et scoring qualite.",
    category: "data",
    pages: 50,
    format: "PDF + Scripts + Checklists",
    color: "#22C55E",
    icon: "D",
    landingUrl: "/guide-data-quality-crm",
    featured: true,
    chapters: [
      "Le vrai cout des donnees sales",
      "Les 5 dimensions de la qualite",
      "Auditer votre base : diagnostic complet",
      "Deduplication : identifier et fusionner",
      "Standardisation : formater pour fiabiliser",
      "Enrichissement IA : Clay, Lemlist AI, Claude",
      "Claude Code : scripts custom",
      "Automatiser la maintenance",
      "Mesurer la qualite dans le temps",
      "Methode Ceres et cas clients",
    ],
    includes: [
      "50 pages de methode + cas concrets",
      "Checklist audit 50 points",
      "10 prompts Claude pour le nettoyage",
      "4 scripts Python Claude Code",
      "Workflow Make enrichissement auto",
      "Template reporting qualite (Sheets)",
      "Comparatif Clay vs Lemlist AI vs Dropcontact",
    ],
    forWho: [
      "RevOps Managers et admins CRM",
      "Equipes qui preparent une migration",
      "Directeurs commerciaux avec un CRM sale",
      "Consultants et agences CRM",
    ],
  },
  {
    slug: "guide-claude-marketing",
    title: "Guide Claude & Claude Code",
    subtitle: "L\u2019IA Anthropic pour le marketing B2B",
    description: "Le guide le plus complet en francais sur Claude et Claude Code pour le marketing B2B. 20+ prompts prouves, 15 cas d\u2019usage, scripts Claude Code, MCP et workflows Make.",
    category: "ia",
    pages: 55,
    format: "PDF + Prompts + Scripts",
    color: "#D4A27F",
    icon: "C",
    landingUrl: "/guide-claude-marketing",
    featured: true,
    chapters: [
      "Claude en 2026 : ou en est-on",
      "Pourquoi Claude pour le marketing B2B",
      "15 cas d\u2019usage marketing avec Claude",
      "Claude pour le content marketing",
      "Claude pour l\u2019outbound et la prospection",
      "Claude pour le CRM et les operations",
      "Claude Code : l\u2019arme secrete",
      "Connecter Claude a votre stack (MCP, Make)",
      "Prompts library : 20+ prompts marketing",
      "Le futur : agents autonomes et coworkers IA",
    ],
    includes: [
      "55 pages de methode + exemples reels",
      "20+ prompts marketing prouves",
      "5 scripts Claude Code prets a l\u2019emploi",
      "3 workflows Make (Claude vers HubSpot)",
      "Guide MCP : connecter Claude a votre CRM",
      "Comparatif Claude vs ChatGPT vs Gemini",
      "Checklist deploiement IA marketing",
    ],
    forWho: [
      "Marketeurs B2B et head of marketing",
      "Growth hackers et founders tech-savvy",
      "Equipes qui veulent integrer l\u2019IA au quotidien",
