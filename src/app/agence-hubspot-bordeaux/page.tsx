...
export const metadata: Metadata = {
  title: "Agence HubSpot Bordeaux — Setup, Migration & Optimisation CRM | Ceres",
  description:
...
const whyBordeaux = [
  { title: "Porte de la Nouvelle-Aquitaine", desc: "Bordeaux est le centre economique de la premiere region de France par sa superficie. On connait le tissu d'entreprises local, du wine tech a l'e-commerce en passant par les services B2B.", color: "#FF7A59" },
  { title: "Ecosysteme tech en plein essor", desc: "Bordeaux Technowest, Darwin, la Cité du Vin numerique, French Tech Bordeaux : l'ecosysteme tech bordelais est en croissance. On accompagne ses acteurs dans leur deploiement CRM.", color: "#4B5EFC" },
  { title: "2h de Paris en TGV", desc: "La LGV rapproche Bordeaux de Paris. On se deplace pour les ateliers de cadrage, formations et go-live dans vos locaux a Merignac, Bordeaux Lac ou centre-ville.", color: "#6D00CC" },
  ...
  { title: "Rayonnement regional", desc: "Depuis Bordeaux, on accompagne aussi vos equipes a Bayonne, Pau, La Rochelle et Limoges. Un seul partenaire HubSpot pour toute la Nouvelle-Aquitaine.", color: "#6C5CE7" },
...
const services = [
  { title: "Setup HubSpot complet", desc: "Configuration de votre instance HubSpot de zero. Pipelines, proprietes custom, vues par equipe, workflows d'automatisation, integrations stack et formation de vos utilisateurs. On configure HubSpot selon vos process, pas l'inverse.", items: ["Cadrage process avec vos equipes", "Config pipelines, proprietes, vues", "Workflows & automatisations", "Integrations stack (Slack, Pennylane, etc.)", "Formation utilisateurs sur site a Bordeaux"], color: "#FF7A59", duration: "3-4 sem", link: "/agence-hubspot" },
  ...
  { title: "Formation HubSpot", desc: "Formation sur site dans vos locaux bordelais ou en remote. Adaptee a vos process, pas un tuto generique. Par equipe : Sales, Marketing, CS, Ops, Direction.", items: ["Formation sur site a Bordeaux", "Sessions par equipe", "Exercices sur vos donnees", "Support post-formation", "Documentation personnalisee"], color: "#22C55E", duration: "1-2 jours", link: "/agence-hubspot" },
...
const clientResults = [
  { client: "E-commerce wine tech Bordeaux", result: "Setup HubSpot complet avec integration plateforme e-commerce. Pipeline adapte aux cycles viticoles.", metric: "3 semaines" },
  { client: "SaaS B2B Merignac", result: "Migration Salesforce vers HubSpot en 5 semaines. Adoption a 93% des le premier mois.", metric: "93% adoption" },
  { client: "Agence services B2B Bordeaux", result: "Optimisation HubSpot : nettoyage de 12 000 contacts, 25 workflows reconstruits, reporting unifie.", metric: "25 workflows" },
];
...
const faqItems = [
  { q: "Combien coute une agence HubSpot a Bordeaux ?", a: "Le cout depend du perimetre : un audit demarre a 2 500\u00a0\u20ac, un setup complet entre 5 000 et 15 000\u00a0\u20ac, une migration entre 8 000 et 25 000\u00a0\u20ac. L'appel de cadrage est gratuit et sans engagement." },
  { q: "Pourquoi choisir une agence HubSpot pour Bordeaux ?", a: "Proximite pour les ateliers sur site, connaissance de l'ecosysteme Nouvelle-Aquitaine (wine tech, e-commerce, services B2B) et reactivite garantie dans le meme fuseau horaire." },
  ...
  { q: "Proposez-vous des formations HubSpot sur site a Bordeaux ?", a: "Oui, nous nous deplacons dans vos locaux bordelais pour des formations adaptees a vos process. Formations par equipe (Sales, Marketing, CS) avec exercices sur vos propres donnees." },
  { q: "HubSpot est-il adapte au secteur wine tech et agroalimentaire ?", a: "Oui. HubSpot gere parfaitement les cycles de vente B2B et B2C, le suivi de campagnes marketing saisonnieres et les integrations e-commerce propres au secteur viticole et agroalimentaire bordelais." },
  { q: "Comment se passe un projet type avec votre agence ?", a: "1) Appel de cadrage gratuit. 2) Proposition detaillee avec perimetre et tarif. 3) Ateliers de cadrage process. 4) Configuration / migration. 5) Formation. 6) Go-live et support post-lancement." },
];

const temoignages = [
  { citation: "Ceres a deploye notre HubSpot en 3 semaines avec une integration e-commerce parfaite. Nos equipes commerciales ont gagne 2h par jour sur la saisie.", auteur: "Directeur Commercial", entreprise: "Wine tech, Bordeaux centre" },
  { citation: "La migration depuis Salesforce a ete transparente. Le double-run nous a permis de continuer a travailler sans interruption pendant la transition.", auteur: "CEO", entreprise: "SaaS B2B, Merignac" },
  { citation: "L'audit de notre instance a revele des dizaines de problemes qu'on ne voyait pas. En 3 semaines, HubSpot est redevenu un vrai outil de pilotage.", auteur: "Head of Sales", entreprise: "Services B2B, Bordeaux Lac" },
];
...
const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      name: "Ceres - Agence HubSpot Bordeaux",
      description: "Agence HubSpot a Bordeaux. Setup, migration, optimisation et formation HubSpot pour entreprises de Nouvelle-Aquitaine. Partenaire certifie, 250+ clients.",
      address: {
        "@type": "PostalAddress",
    ...
    {
      "@type": "Service",
      name: "Agence HubSpot Bordeaux",
      provider: { "@type": "Organization", name: "Ceres" },
      description: "Agence HubSpot a Bordeaux specialisee RevOps & IA. Configuration, migration Salesforce, optimisation, formation sur site.",
...
export default function AgenceHubSpotBordeauxPage() {
  return (
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-6">
        ...
        <nav aria-label="Breadcrumb" className="mb-8">
          <ol className="flex items-center gap-1.5 text-[12px] text-[#999]">
            ...
            <li>/</li>
            <li className="text-[#111] font-medium">Bordeaux</li>
          </ol>
        </nav>

        {/* ── 1. Hero ──────────────────────────────────────────────────────────── */}
        <section className="text-center mb-20">
          <div className="mb-4"><Badge>Agence HubSpot Bordeaux</Badge></div>
          <h1 className="text-[36px] sm:text-[48px] font-semibold text-[#111] leading-[1.1] tracking-[-0.03em] mb-5">
            Agence HubSpot a Bordeaux : votre partenaire certifie
          </h1>
          <p className="text-[17px] text-[#666] max-w-[580px] mx-auto leading-[1.7] mb-6">
            Setup, migration, optimisation et formation HubSpot. Nous accompagnons les entreprises de Nouvelle-Aquitaine dans le deploiement et l&apos;exploitation de HubSpot depuis 9 ans.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-6 mb-8">
            ...
            <div className="text-center">
              ...
              <p className="text-[12px] text-[#999]">Paris-Bordeaux Saint-Jean</p>
            </div>
          </div>
          <Link
            href="/contact"
        ...
        {/* ── 2. Pourquoi choisir une agence HubSpot a Bordeaux ──────────────── */}
        <section>
          <div className="text-center mb-10">
            ...
            <h2 className="text-[24px] sm:text-[30px] font-semibold text-[#111] tracking-[-0.02em] mb-2">
              Pourquoi choisir une agence HubSpot a Bordeaux
            </h2>
            <p className="text-[13px] text-[#999] max-w-[520px] mx-auto">
              Travailler avec une agence HubSpot proche de Bordeaux, c&apos;est gagner en reactivite, en comprehension de votre ecosysteme regional et en efficacite sur le terrain.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {whyBordeaux.map((item) => (
        ...
        <section>
          <div className="text-center mb-10">
            ...
            <h2 className="text-[24px] sm:text-[30px] font-semibold text-[#111] tracking-[-0.02em] mb-2">
              Nos services HubSpot a Bordeaux
            </h2>
            <p className="text-[13px] text-[#999] max-w-[520px] mx-auto">
          ...
          <div className="rounded-2xl bg-[#111] p-6 md:p-10">
            <div className="mb-8">
              ...
              <h2 className="text-[24px] sm:text-[30px] font-semibold text-white tracking-[-0.02em] mb-2">
                Partenaire HubSpot certifie a Bordeaux
              </h2>
            ...
            <div className="mt-8 pt-6 border-t border-white/10">
              <h3 className="text-[14px] font-semibold text-white mb-3">Zones d&apos;intervention depuis Bordeaux</h3>
              <ul className="space-y-2">
                {[
                  "Bordeaux et agglom\u00e9ration (centre-ville, M\u00e9rignac, Bordeaux Lac, Talence)",
                  "Bassin d'Arcachon et littoral atlantique",
                  "Bayonne, Biarritz et Pays basque",
                  "Pau et B\u00e9arn",
        ...
        <section>
          <div className="text-center mb-10">
            ...
            <h2 className="text-[24px] sm:text-[30px] font-semibold text-[#111] tracking-[-0.02em] mb-2">
              Migration vers HubSpot depuis Bordeaux
            </h2>
            <p className="text-[13px] text-[#999] max-w-[520px] mx-auto">
              Vous utilisez Salesforce, Dynamics 365 ou Pipedrive et vous envisagez HubSpot. Notre agence gere la migration de A a Z pour les entreprises bordelaises.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-[#E8E8E8] bg-white p-6 md:p-10 shadow-[0_4px_20px_-8px_rgba(0,0,0,0.06)]">
            <div className="mb-8">
              ...
              <h2 className="text-[20px] sm:text-[24px] font-semibold text-[#111] tracking-[-0.02em]">
                Questions frequentes sur notre agence HubSpot a Bordeaux
              </h2>
            </div>
        ...
        <section>
          <div className="text-center mb-10">
            ...
            <h2 className="text-[24px] sm:text-[30px] font-semibold text-[#111] tracking-[-0.02em]">
              Ce que disent nos clients bordelais
            </h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {temoignages.map((t, i) => (
        ...
        <section>
          <div className="rounded-2xl border border-[#E8E8E8] bg-[#FAFAFA] p-8 md:p-12 text-center">
            <h2 className="text-[24px] sm:text-[30px] font-semibold text-[#111] tracking-[-0.02em] mb-3">
              Un projet HubSpot a Bordeaux ?
            </h2>
            <p className="text-[14px] text-[#999] mb-3 max-w-[480px] mx-auto">
              Setup, migration, optimisation, formation ou administration recurrente. Notre agence HubSpot vous accompagne de A a Z sur toute la region Nouvelle-Aquitaine. L&apos;appel de cadrage est gratuit et sans engagement.
            </p>
            <p className="text-[12px] text-[#999] mb-6">Bordeaux -- 2h de Paris en TGV</p>
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-5 py-2 rounded-md bg-[#111] text-white text-[13px] font-medium hover:bg-[#222] transition-colors"
            >
