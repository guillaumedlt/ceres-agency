...
const jsonLd = {
  ...
  inLanguage: "fr",
  mainEntityOfPage: "https://ceres.agency/guide-ia-commercial/contenu",
...
export default function GuideIAContenuPage() {
  ...
  /* Share helpers */
  const shareUrl = typeof window !== "undefined" ? window.location.href : "https://ceres.agency/guide-ia-commercial/contenu";
          ...
          <section className="mb-8">
            <div className="rounded-2xl border border-[#E8E8E8] bg-white p-5 md:p-8 shadow-[0_4px_20px_-8px_rgba(0,0,0,0.06)]">
              ...
              <div className="space-y-3">
                ...
                <Link href="/audit-revops" className="flex items-center gap-3 text-[13px] text-[#555] hover:text-[#6D00CC] transition-colors group">
