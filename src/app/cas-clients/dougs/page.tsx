...
Actions automatiques :
  ...
  4. Si pas de contact dans 48h -> alerte manager`}
            ...
            <div className="mt-8 mb-4 rounded-xl border border-[#F2F2F2] p-4 flex items-center gap-3">
              <div className="w-3 h-3 rounded-sm shrink-0" style={{ backgroundColor: "#FF7A59" }} />
              <div>
                <Link href="/agence-hubspot" className="text-[13px] font-semibold text-[#111] hover:text-[#4B5EFC] transition-colors">Decouvrir notre agence HubSpot →</Link>
                <p className="text-[11px] text-[#999]">Migration Salesforce vers HubSpot, deploiement CRM et marketing automation</p>
              </div>
            </div>
