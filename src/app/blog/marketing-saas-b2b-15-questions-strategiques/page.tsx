...
const jsonLd = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://ceres.agency/blog/marketing-saas-b2b-15-questions-strategiques" },
            ...
            <div className="sticky top-28">
              ...
              <div className="mt-8 pt-6 border-t border-[#F2F2F2]">
                ...
                <div className="flex gap-2">
                  <a href="https://twitter.com/intent/tweet?url=https://ceres.agency/blog/marketing-saas-b2b-15-questions-strategiques&text=Marketing%20SaaS%20B2B%20:%2015%20questions%20strat%C3%A9giques%20in%C3%A9vitables" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg border border-[#F0F0F0] flex items-center justify-center text-[#CCC] hover:text-[#666] hover:border-[#DDD] transition-colors">
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                  </a>
                  <a href="https://www.linkedin.com/sharing/share-offsite/?url=https://ceres.agency/blog/marketing-saas-b2b-15-questions-strategiques" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg border border-[#F0F0F0] flex items-center justify-center text-[#CCC] hover:text-[#666] hover:border-[#DDD] transition-colors">
            ...
            <article>
              ...
              <section id="q2" className="mb-8">
                <QuestionCard number={2} title="Qui est votre ICP ?">
                  ...
                  <p><strong className="text-[#111]">Erreurs courantes.</strong> Definir un ICP trop large (&ldquo;toutes les entreprises B2B&rdquo;). Avoir plusieurs ICP des le debut sans les prioriser. Ne pas distinguer l&apos;utilisateur du decideur et du champion interne. Ignorer les signaux negatifs (quels profils churnent le plus).</p>
              ...
              <section id="q3" className="mb-8">
                <QuestionCard number={3} title="Pourquoi vous plutot qu&apos;un autre ?">
                  ...
                  <p><strong className="text-[#111]">Erreurs courantes.</strong> Revendiquer un differenciateur que tout le monde revendique (&ldquo;interface simple&rdquo;, &ldquo;excellent support&rdquo;). Ignorer la concurrence indirecte (spreadsheets, process manuels). Se positionner sur un differenciateur non verifiable par le prospect avant l&apos;achat.</p>
              ...
              <section id="q6" className="mb-8">
                <QuestionCard number={6} title="Quel est votre cout d&apos;acquisition acceptable ?">
                  ...
                  <p><strong className="text-[#111]">Erreurs courantes.</strong> Ne pas inclure les salaires dans le calcul du CAC. Calculer un CAC global au lieu de le segmenter par canal. Ignorer le payback period (combien de mois pour rembourser le CAC). Comparer son CAC a des benchmarks sans tenir compte de son propre modele de pricing.</p>
              ...
              <section id="q9" className="mb-8">
                <QuestionCard number={9} title="Faut-il investir dans le SEO des maintenant ?">
                  ...
                  <p><strong className="text-[#111]">Erreurs courantes.</strong> Ecrire des articles top-funnel generiques (&ldquo;Qu&apos;est-ce que le B2B ?&rdquo;) qui attirent du trafic non qualifie. Ignorer le SEO technique (vitesse, indexation, structure). Ne pas avoir de strategie de mots-cles avant de commencer a ecrire. Publier 3 articles puis abandonner en attendant des resultats.</p>
