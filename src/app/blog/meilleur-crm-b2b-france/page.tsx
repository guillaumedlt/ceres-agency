...
const jsonLd = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://ceres.agency/blog/meilleur-crm-b2b-france" },
            ...
            <div className="sticky top-28">
              ...
              <div className="mt-8 pt-6 border-t border-[#F2F2F2]">
                ...
                <div className="flex gap-2">
                  <a href="https://twitter.com/intent/tweet?text=Le%20meilleur%20CRM%20B2B%20en%20France%20en%202026&url=https://ceres.agency/blog/meilleur-crm-b2b-france" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg border border-[#F0F0F0] flex items-center justify-center text-[#CCC] hover:text-[#666] hover:border-[#DDD] transition-colors">
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                  </a>
                  <a href="https://www.linkedin.com/sharing/share-offsite/?url=https://ceres.agency/blog/meilleur-crm-b2b-france" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg border border-[#F0F0F0] flex items-center justify-center text-[#CCC] hover:text-[#666] hover:border-[#DDD] transition-colors">
